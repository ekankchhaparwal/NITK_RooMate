...
CREATE TABLE SWAP_REQUEST (
    ...
    REQ_ROOM_ID           VARCHAR(10) NOT NULL,
    REQ_TO_ROOM_ID        VARCHAR(10) NOT NULL,
    CONFIRM_AVAILABILITY  CHAR(1) NOT NULL,
    ...
    CONSTRAINT CHECK_CONFIRM_AVAILABILITY CHECK (CONFIRM_AVAILABILITY IN ('Y', 'N'))
);

/*comment on table "SWAP_REQUEST" is 'Manages requests made by students to swap rooms';*/
